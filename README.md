Travis-ci status: [![Build Status](https://secure.travis-ci.org/jackl0phty/opschef-cookbook-rackspace.png?branch=master)](http://travis-ci.org/jackl0phty/opschef-cookbook-rackspace)
